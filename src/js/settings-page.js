...
const SaveModal = require('./validate-on-save-modal');
const confirm = require('hp-autonomy-js-whatever/src/js/confirm');
const ensureArray = require('hp-autonomy-js-whatever/src/js/ensure-array');
const listenable = require('hp-autonomy-js-whatever/src/js/listenable');
const template = require('../templates/settings-page.html');
 ...
 * @extends BasePage
 */
module.exports = BasePage.extend(/** @lends module:settings/js/settings-page.SettingsPage.prototype */ {
    /**
     * @typedef ConfigModel
