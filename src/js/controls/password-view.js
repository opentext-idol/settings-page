...
const template = _.template(require('../../templates/controls/password-view.html'));
 ...
 */
module.exports = Backbone.View.extend(/** @lends module:settings/js/controls/password-view.PasswordView.prototype*/ {
    /**
