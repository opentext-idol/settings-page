...
const template = _.template(require('../../templates/widgets/mail-widget.html'));
 ...
 */
module.exports = ServerWidget.extend(/** @lends module:settings/js/widgets/mail-widget.MailWidget.prototype */{
    events: _.extend({
