...
const template = require('../../templates/widgets/logging-widget.html');
 ...
 */
module.exports = Widget.extend(/** @lends module:settings/js/widgets/logging-widget.LoggingWidget.prototype */ {
