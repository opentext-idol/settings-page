...
const ServerWidget = require('../server-widget');
const PasswordView = require('../controls/password-view');
const template = require('../../templates/widgets/database-widget.html');
const selectionTemplate = require('../../templates/widgets/databases-widget.html');
 ...
 */
module.exports = ServerWidget.extend(/** @lends module:settings/js/widgets/database-widget.DatabaseWidget.prototype */{
