...
const template = _.template(require('../../templates/widgets/alerts-widget.html'));
 ...
 */
module.exports = Widget.extend(/** @lends module:settings/js/widgets/alerts-widget.AlertsWidget.prototype */ {
