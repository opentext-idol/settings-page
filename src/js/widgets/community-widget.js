...
const DropdownView = require('../controls/aci-widget-dropdown-view');
const SecurityTypesModel = require('../models/security-types-model');
 ...
 */
module.exports = AciWidget.extend(/** @lends settings/js/widgets/community-widget.CommunityWidget.prototype */{
