...
const template = require('../../templates/widgets/aci-widget.html');
 ...
 */
module.exports = ServerWidget.extend(/** @lends module:settings/js/widgets/aci-widget.AciWidget.prototype */{
