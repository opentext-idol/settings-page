...
const template = _.template(require('../../templates/widgets/tasks-widget.html'));
 ...
 */
module.exports = Widget.extend(/** @lends module:settings/js/widgets/tasks-widget.TasksWidget.prototype */ {
    /**
