...
const serverSelectionTemplate = require('../../templates/widgets/server-selection-template.html');
const template = require('../../templates/widgets/distributed-widget.html');
...
module.exports = ServerWidget.extend({
