...
const template = require('../../templates/widgets/port-widget.html');
 ...
 */
module.exports = Widget.extend(/** @lends module:settings/js/widgets/port-widget.PortWidget.prototype */{
    /**
