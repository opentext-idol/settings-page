...
const template = _.template(require('../../templates/widgets/single-user-widget.html'));
 ...
 */
module.exports = Widget.extend(/** @lends module:settings/js/widgets/single-user-widget.SingleUserWidget.prototype */{
